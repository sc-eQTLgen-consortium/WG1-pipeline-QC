...
outdir <- arguments[1,]
data_score <- read_delim(as.character(arguments[2,]), delim = "\t")
onekg_score <- read_delim(as.character(arguments[3,]), delim = "\t")
onekg_anc <- read_delim(as.character(arguments[4,]), delim = "\t")
data_anc <- read_delim(as.character(arguments[5,]), delim = "\t")
sex_check <- read_delim(as.character(arguments[6,]), delim = "\t")
