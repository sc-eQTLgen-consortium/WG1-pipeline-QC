...
#. Finally, let's create a report that includes all of our results and some pipeline metrics:
   ...
   This will generate an html report that includes figures and pipeline metrics called ``demultiplexing_report.html``.
...
Each of the figures generated by this pipeline are included in the ``demultiplexing_report.html`` and it can therefore be used to check the results of the pipeline.
