...
wget -q https://www.dropbox.com/s/uy9828g1r1jt5xy/ImputationTestDataset_plink.tar.gz \
...
wget -q https://www.dropbox.com/s/3oujqq98y400rzz/TestData4PipelineFull.tar.gz \
